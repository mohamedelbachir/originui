...
const index = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-white pb-20 dark:bg-black">
      ...
      <article className="relative z-2 grid px-4 py-40 sm:px-0 2xl:pt-52 2xl:pb-24">
        <a
          href={item?.href}
        ...
        <p className="mx-auto mt-5 text-center text-sm text-black sm:w-[80%] sm:text-lg lg:w-[700px] dark:text-white">
          50+ Stunning Sections and Templates Powered by <strong>React</strong>,{" "}
          <strong>TypeScript</strong>,<strong> Tailwind CSS</strong>, and{" "}
          <strong> Tailwind CSS</strong>. Save countless hours , craft
          eye-catching landing pages, and turn visitors into loyal customers
        </p>
