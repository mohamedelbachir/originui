...
import { BadgeCheck, Download, Star, StarHalf } from "lucide-react";
          ...
          <div className="order-2 flex flex-col space-y-6 md:order-1">
            ...
            <div className="flex items-center space-x-1 text-sm">
              <div className="flex">
                ...
                <Star className="h-4 w-4 fill-current text-yellow-500" />
                <Star className="h-4 w-4 fill-current text-yellow-500" />
                <StarHalf className="h-4 w-4 fill-current text-yellow-500" />
              </div>
              <span className="text-muted-foreground">
                4.8/5 from 2,945 reviews
              </span>
            </div>

            <div>
              <h1 className="mb-3 text-3xl leading-tight font-bold md:text-4xl lg:text-5xl">
                Your life, <span className="text-primary">organized</span> and
                simplified
              </h1>
              <p className="text-muted-foreground text-base md:pr-10 md:text-lg">
                Our app helps you organize tasks, manage projects, and achieve
                your goals with a beautifully designed, distraction-free
                interface.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button
                variant="outline"
                size="lg"
                className="gap-2 dark:border-zinc-800"
                asChild
              >
            ...
            <div className="flex flex-col space-y-4 pt-4">
              <h3 className="text-sm font-medium">Why users love our app:</h3>
          ...
          <div className="relative order-1 flex justify-center md:order-2 md:h-[600px]">
            ...
            <div className="relative mt-4 max-w-[280px] md:mt-0 md:max-w-full">
              ...
              <div className="relative z-30 overflow-hidden rounded-[2.5rem] border-8 border-zinc-900 shadow-xl dark:border-zinc-800">
                <Image
                  src="/app-screen-tasks.png"
                  alt="App screenshot showing task management interface"
                  width={280}
                  height={580}
              ...
              <div className="absolute top-24 -right-20 z-20 hidden rotate-6 transform overflow-hidden rounded-[2.5rem] border-8 border-zinc-900 shadow-xl md:-right-32 md:block dark:border-zinc-800">
                <Image
                  src="/app-screen-calendar.png"
                  alt="App screenshot showing calendar interface"
                  width={240}
                  height={520}
                  className="h-auto max-w-full rounded-[2rem] bg-zinc-950"
                />
              ...
              {/* Notification card */}
              <div className="bg-card absolute top-16 -left-8 z-40 hidden rounded-xl p-3 shadow-lg sm:block md:-left-16 dark:bg-zinc-900">
                <div className="flex items-center gap-2">
                  <div className="bg-primary/20 flex h-10 w-10 items-center justify-center rounded-full">
                    <Download className="text-primary h-5 w-5" />
                  </div>
                  <div>
                    <div className="text-xs font-medium">Daily Reminder</div>
              ...
              <div className="bg-card absolute -right-12 -bottom-6 z-40 hidden rounded-xl p-3 shadow-lg sm:block dark:bg-zinc-900">
                <div className="flex flex-col">
                  ...
                  <div className="mt-1 h-2 w-24 rounded-full bg-zinc-200 dark:bg-zinc-800">
                    <div className="bg-primary h-2 w-[87%] rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
