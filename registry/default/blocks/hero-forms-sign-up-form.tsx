...
export default function HeroFormSignUpForm() {
  return (
    <>
      {/* Hero */}
      <div className="from-primary-foreground via-primary-foreground to-background relative bg-gradient-to-bl">
        <div className="container mx-auto px-4 py-24 sm:py-32 md:px-6 2xl:max-w-[1400px]">
          {/* Grid */}
          <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
            <div>
              ...
              <blockquote className="relative hidden max-w-sm md:block">
                <svg
                  className="text-foreground/10 absolute start-0 top-0 h-16 w-16 -translate-x-6 -translate-y-8 transform"
                  width={16}
                  height={16}
                  viewBox="0 0 16 16"
                  fill="none"
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="relative">
                        <Separator className="my-3 flex items-center justify-center">
                          <div className="bg-background text-muted-foreground flex items-center px-6 text-xs uppercase">
                            Or
                          </div>
                        </Separator>
                      </div>
                      <div className="mt-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <Button className="col-span-2 mt-3">
                            Get started
                          </Button>
                        </div>
                        {/* Grid End */}
          ...
          {/* End Grid */}
          {/* Clients Section */}
          <div className="text-muted-foreground after:border-t-muted-foreground/50 mt-6 flex items-center gap-x-1.5 py-3 text-sm after:ms-6 after:flex-[1_1_0%] after:border-t md:mt-12">
          ...
          <div className="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
            <svg
              className="text-muted-foreground h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
