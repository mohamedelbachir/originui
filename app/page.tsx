...
function SimpleCard({
  ...
  return (
    <div className="space-y-3 text-center">
      <Link
        href={`/${slug}`}
        className="peer relative flex h-40 items-center justify-center overflow-hidden rounded-xl border bg-muted hover:bg-muted/80 transition-colors dark:border-zinc-700/80"
      >
